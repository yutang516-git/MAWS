...
class M2fnet(nn.Module):
    def __init__(self,
        ...
        # self.sam = sam_model_registry["vit_l"](args, checkpoint='/media/cv516/bd0168d7-5900-4ac4-8a7c-3b0b924eebf7/zyt/MFnet/sam_vit_l_0b3195.pth')
        # self.sam = sam_model_registry["vit_h"](args,checkpoint='/media/cv516/bd0168d7-5900-4ac4-8a7c-3b0b924eebf7/zyt/MFnet/sam_vit_h_4b8939.pth')
