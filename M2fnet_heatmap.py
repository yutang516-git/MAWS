...
class M2fnet(nn.Module):
    ...
    #     y = y.repeat(1, 3, 1, 1)
    #     deepx, deepy = self.image_encoder(x, y)  # batch*256*16*16
    #     heatmaps = []
    ...
    def forward(self, x, y, mode='Train'):
        ...
        # 方案1：使用特定通道的所有像素点的平均值
        target_channel = 2 # 选择第个通道
        pred = x[:, target_channel, :, :].mean()  # 计算该通道所有像素的平均值
